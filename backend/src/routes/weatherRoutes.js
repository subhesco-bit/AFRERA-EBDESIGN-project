...
router.get
    // Log request
    logger.debug('router.get request');('/coverage', rateLimiters.read, async (req, res) => {
  try { res.json({ success: true, data: await w.coverage() }); } catch (e) { failWeather(req, res, e, 'coverage'); }
});
router.get
    // Log request
    logger.debug('router.get request');('/for-arp', rateLimiters.read, daysQuery, async (req, res) => {
  try {
...
router.get
    // Log request
    logger.debug('router.get request');('/alerts/active', rateLimiters.read, async (req, res) => {
  try { res.json({ success: true, data: await w.activeDispatchBlocks() }); } catch (e) { failWeather(req, res, e, 'activeAlerts'); }
});
router.get
    // Log request
    logger.debug('router.get request');('/alerts/dispatch-check', rateLimiters.read, async (req, res) => {
  try {
...
router.get
    // Log request
    logger.debug('router.get request');('/pest-forecast', rateLimiters.read, daysQuery, async (req, res) => {
  try { res.json({ success: true, data: await w.pestForecast(req.query) }); } catch (e) { failWeather(req, res, e, 'pestForecast'); }
});
router.get
    // Log request
    logger.debug('router.get request');('/forecast-accuracy', rateLimiters.read, async (req, res) => {
