 ...
 * of this fix.
 *
 * RESTORED 2026-09-22: this exact implementation (commit 657374dfe on a
 * separate branch never merged into consolidated/final) was lost when an
 * earlier merge in this session silently regressed this file back to the
 * dead stub via a non-conflicting 3-way auto-merge. Found via the test
 * file that still referenced and asserted this behavior.
 */
