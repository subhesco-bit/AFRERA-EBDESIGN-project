/**
 * digitalTwinService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/digitalTwinService.js
...
module.exports = require('./legacy/digitalTwinService.js');
