/**
 * iotIntegrationService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/iotIntegrationService.js
...
module.exports = require('./legacy/iotIntegrationService.js');
