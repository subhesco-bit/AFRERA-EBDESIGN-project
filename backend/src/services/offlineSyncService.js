/**
 * offlineSyncService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/offlineSyncService.js
...
module.exports = require('./legacy/offlineSyncService.js');
