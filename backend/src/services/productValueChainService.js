...
const CACHE_TTL_MS = cacheTtlMs('VALUE_CHAIN', 6 * 60 * 60 * 1000);
const OUTPUT_TOKEN_LIMIT = outputTokenLimit('VALUE_CHAIN', 320);
...
function getStatus() {
  return {
    ...
    tokenOptimization: { ...getAIRuntimePolicy(), maxOutputTokens: OUTPUT_TOKEN_LIMIT, cacheTtlMs: CACHE_TTL_MS, cacheEntries: aiCopyCache.size },
    enterpriseIntegration: getEnterpriseCapabilityPolicy(),
