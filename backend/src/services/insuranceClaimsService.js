/**
 * insuranceClaimsService (thin wrapper)
 *
 ...
 * unreachable from any mounted route. backend/src/services/legacy/insuranceClaimsService.js
...
module.exports = require('./legacy/insuranceClaimsService.js');
