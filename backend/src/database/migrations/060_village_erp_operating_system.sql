-- 060_village_erp_operating_system.sql
...
-- All money uses NUMERIC. Village records remain linked to the canonical
-- villages table and the platform's single ERP company/ledger.
