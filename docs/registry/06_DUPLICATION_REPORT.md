...
## Tables defined more than once (39)
...
- **platform_configurations** — backend/src/database/migrations/014_platform_foundation_modules.sql + backend/src/database/migrations/1001_platform_configuration.sql
...
- **promotions** — backend/src/database/migrations/3102_ecommerce_ai_erp_business_marketing.sql + backend/src/database/migrations/3200_hr_module_schema.sql
...
- **departments** — backend/src/database/migrations/3200_hr_module_schema.sql + backend/src/database/migrations/996_enterprise_foundation.sql
...
## Index names reused on different tables (7)
