...
export const managementRoutes = [
  ...
  },
  {
    ...
    title: 'Clinical Coding Integration - AFRERA',
    description: 'AI-assisted, clinician-reviewed medical coding for occupational health, telehealth, insurance, ERP finance and audit',
    keywords: 'medical coding, clinical documentation, insurance claims, occupational health, ERP, AI',
    transition: 'fade',
  },
  {
    path: '/diet-recipes',
