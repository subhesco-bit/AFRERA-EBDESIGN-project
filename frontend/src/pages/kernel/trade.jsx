...
export default function TradePage() {
  const { data, loading, error } = useKernelGet('/flows/offtake-settle/run');
  return (
    <KernelShell title="Trade" subtitle="Declared ₹/kg. Freight declared (zero allowed). Journal balances. paymentRef required." loading={loading} error={error}>
      {data && <>
