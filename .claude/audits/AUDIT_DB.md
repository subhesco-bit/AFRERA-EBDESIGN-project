...
Overall status is **warn**: the schema itself is real, migrated, and CI-verified at the structural level, but coverage of query *correctness* is weaker than the file layout suggests, and there are concrete, fixable index and N+1 gaps.
